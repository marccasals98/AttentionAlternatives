...
#SBATCH --verbose
#SBATCH --output=/path/to/project/outputs/ser_2025/logs/experiments_consistency/%x_%j.txt

date +%Y-%m-%d_%H:%M:%S

cd /path/to/project/marc_git_repositories/SER2025

# activate env
source /path/to/project/environments/ser_2025/bin/activate
...
srun python scripts/train.py \
	--train_data_dir '/path/to/project/data/EmoSPeech2024/data/train_segments' \
	--validation_data_dir '/path/to/project/data/EmoSPeech2024/data/train_segments' \
	--train_labels_path '/path/to/project/data/EmoSPeech2024/data/train_split.tsv' \
	--validation_labels_path '/path/to/project/data/EmoSPeech2024/data/dev_split.tsv' \
	--dataset_transcriptions_dir '/path/to/project/data/EmoSPeech2024/data/transcripts' \
    --sample_rate 44100 \
