...
uv run torchrun --nproc_per_node=1 scripts/train.py \
	...
	--train_labels_path '/path/to/project/data/msp_podcast/custom_data/generated_training_labels/25_01_02_17_03_37_111942/toy_training_labels.tsv' \
	--validation_labels_path '/path/to/project/data/msp_podcast/custom_data/generated_training_labels/25_01_02_17_03_37_111942/toy_development_labels.tsv' \
	...
	--seq_to_seq_method 'FoX' \
	--seq_to_seq_heads_number 10 \
